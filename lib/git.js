 ...
 */
export function repoFromRemoteUrl(remote, apiHost = 'github.com') {
 ...
 */
export async function readGitState(cwd, runGit = runGitCli, signal, apiHost = 'github.com') {
    const state = {
        branch: null,
        hasChanges: false,
        changedFiles: [],
