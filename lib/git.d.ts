...
export declare function repoFromRemoteUrl(remote: string): string | null;
/**
 ...
 */
export declare function readGitState(cwd: string, runGit?: GitRunner, signal?: AbortSignal): Promise<GitState>;
