...
import { prCreateTool, ghReviewTool, reviewPostTool, ghIssueTool, issueOpenTool } from "./tools.js";
...
export function applyWithDeps(ctx, config, deps = {}) {
    const state = createState(ctx, config, deps.runGit ?? runGitCli, deps.runGh ?? runGhCli, deps.fetchImpl);
