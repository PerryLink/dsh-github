...
export const Config: z<Config> = z.object({
  ...
  maxDiffChars: z.number().step(1).min(1)
    .default(8000)
    .description('Byte cap for PR diffs read into a review.'),
  ...
  allowedActions: z.array(z.union(['pr.create', 'review.post', 'issue.create'] as const))
    .default(['pr.create', 'review.post', 'issue.create'])
