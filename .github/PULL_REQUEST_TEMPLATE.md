...
- [ ] The full gate is green: `pnpm run typecheck && pnpm test && pnpm run build && pnpm run check:readmes`
- [ ] Tests were added or updated for the change
- [ ] `CHANGELOG.md` has an entry under `## [Unreleased]`
- [ ] All five READMEs (`README.md`, `README.zh-CN.md`, `README.es.md`, `README.pt.md`, `README.hi.md`) stay in sync where the change touches docs (English is the source of truth)
